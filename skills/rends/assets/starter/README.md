...
`0.11.0` from the public package CDN. The package dependency is pinned to the
...
open `index.html`. Keep the package dependency, CDN URLs, `sources.json`, and
the repository package version synchronized when updating Ren10.
