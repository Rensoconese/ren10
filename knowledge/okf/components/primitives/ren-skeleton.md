...
sourcePath: components/primitives/ren-skeleton
packageName: ren10
...
Source path: `components/primitives/ren-skeleton`

## Relationships

- `exposes_selector` -> [.ren-skeleton](../../selectors/ren-skeleton.md)
- `exposes_selector` -> [.ren-skeleton-circle](../../selectors/ren-skeleton-circle.md)
- `exposes_selector` -> [.ren-skeleton-heading](../../selectors/ren-skeleton-heading.md)
- `exposes_selector` -> [.ren-skeleton-rect](../../selectors/ren-skeleton-rect.md)
- `exposes_selector` -> [.ren-skeleton-text](../../selectors/ren-skeleton-text.md)
- `has_contract` -> [ren-skeleton component.md](../../foundation/contract-primitive-ren-skeleton.md)
- `has_css` -> [ren-skeleton.css](../../css/ren-skeleton-css.md)
- `has_docs_page` -> [ren-skeleton docs](../../docs/ren-skeleton-docs.md)
...
- `uses_token` -> [--duration-loop-slow](../../tokens/duration-loop-slow.md)
