...
sourcePath: components/composites/ren-hover-card/ren-hover-card.js
packageName: ren10
...
Source path: `components/composites/ren-hover-card/ren-hover-card.js`
