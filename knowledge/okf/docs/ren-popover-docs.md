...
Source path: `docs/components/ren-popover.html`
        ...
        <div class="dx-demo">
          <div class="dx-demo-preview">
            <div class="demo-pop" id="popover-demo">
              ...
              <div class="demo-pop-content" id="popover-demo-content" role="dialog" aria-label="Filters" hidden>
                <p style="font-size: var(--text-sm); font-weight: var(--weight-semibold); margin: 0 0 var(--space-2);">Filter posts</p>
                <label class="ren-checkbox" style="font-size: var(--text-sm);"><input type="checkbox" checked><span class="ren-checkbox-control"></span><span>Drafts</span></label>
                <label class="ren-checkbox" style="font-size: var(--text-sm); margin-top: var(--space-1);"><input type="checkbox"><span class="ren-checkbox-control"></span><span>Archived</span></label>
