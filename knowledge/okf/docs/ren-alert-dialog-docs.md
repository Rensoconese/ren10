...
# ren-alert-dialog docs

Source path: `docs/components/ren-alert-dialog.html`
  ...
  <div class="dx-shell dx-shell-grid">
    ...
    <main class="dx-content">
      <header class="dx-header">
        ...
        <h1>Alert Dialog <span class="dx-api-badge dx-api-badge-hybrid" title="Renders without JS; JS adds enhancements">Hybrid</span></h1>
      ...
      <section class="dx-section" id="demo">
        ...
        <div class="dx-demo">
          <div class="dx-demo-preview">
            <button class="ren-btn ren-btn-danger" type="button" data-trigger="alert-demo">Delete account</button>
          </div>
          <pre class="dx-pre dx-demo-code" tabindex="0"><code>&lt;button data-dialog-trigger="confirm-delete"&gt;Delete account&lt;/button&gt;

&lt;ren-alert-dialog id="confirm-delete" aria-labelledby="cd-title"&gt;
  &lt;dialog class="ren-dialog ren-alert-dialog"&gt;
    &lt;div class="ren-dialog-header"&gt;
      &lt;h2 class="ren-dialog-title" id="cd-title"&gt;Delete this account?&lt;/h2&gt;
    &lt;/div&gt;
    ...
    &lt;div class="ren-dialog-footer"&gt;
      ...
      &lt;button class="ren-btn ren-btn-danger" data-dialog-close&gt;Delete account&lt;/button&gt;
    &lt;/div&gt;
  &lt;/dialog&gt;
&lt;/ren-alert-dialog&gt;</code></pre>
        </div>
      </section>
      ...
      <section class="dx-section" id="api">
        ...
        <h2>API</h2>
        <p>Inherits everything from <a href="ren-dialog.html" class="ren-link">Dialog</a>. The differences:</p>
        <table class="dx-api">
          <thead><tr><th>Class / element</th><th>Effect</th></tr></thead>
          <tbody>
            <tr><td><code class="dx-api-name">&lt;ren-alert-dialog&gt;</code></td><td>Wrapper. Disables backdrop click. Sets <code>role="alertdialog"</code> on the inner dialog.</td></tr>
            <tr><td><code class="dx-api-name">.ren-alert-dialog</code></td><td>Class on the inner <code>&lt;dialog&gt;</code>. Visual is identical to <code>.ren-dialog</code>; the difference is behavioral.</td></tr>
          </tbody>
        </table>
        <p>For full attribute / event documentation, see the <a href="ren-dialog.html#api" class="ren-link">Dialog API</a>.</p>
      </section>
      ...
      <section class="dx-section" id="a11y">
        ...
        <h2>Accessibility</h2>
        <ul>
          <li>Inner <code>&lt;dialog&gt;</code> uses <code>role="alertdialog"</code> — assistive tech treats it as a forced confirmation.</li>
          <li>Focus is trapped inside until a button is clicked.</li>
          <li><kbd>Esc</kbd> is suppressed by default. Override with <code>allow-escape</code> attribute if your scenario allows it.</li>
  ...
  <script type="module" src="../../components/composites/ren-alert-dialog/ren-alert-dialog.js"></script>
